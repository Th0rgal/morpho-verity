...
""",
    "expected": "qualified library helper call 'Callbacks.callback' is only supported as a monadic bind source",
  },
  {
    "name": "erc20_transfer",
    "blocker": "erc20",
...
""",
    "expected": "qualified library helper call 'ERC20.safeTransfer' is only supported as a monadic bind source",
  },
  {
...
""",
    "expected": "qualified library helper call 'ERC20.safeTransferFrom' is only supported as a monadic bind source",
  },
  {
