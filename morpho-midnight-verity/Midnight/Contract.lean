...
verity_contract Midnight where
  ...
  function allow_post_interaction_writes take
    ...
    if offer.buy then
      ...
      pure ()
    emit "Take"
      [sender, id, units, taker, offer.maker, offer.buy, offer.group,
        buyerAssets, sellerAssets, newConsumed, buyerPendingFeeIncrease,
        sellerPendingFeeDecrease, buyerCreditIncrease, sellerCreditDecrease,
        receiver, payer]
