/-
  ...
  Layout:
    * `LIF` and `ltvBelowInvLif` - transcribed from `liquidate`
      (morpho-blue-verity/Morpho/Contract.lean:856-860) and stated division-free. `WAD_le_LIF` /
...
/-- Liquidation incentive factor, transcribed from morpho-blue-verity/Morpho/Contract.lean:856-860:
